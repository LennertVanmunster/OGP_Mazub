...
public class GetHeigth extends GetDoubleValueOf {
	 ...
	 */
	public GetHeigth(Expression<GameObjectType> expression, SourceLocation sourceLocation) {
		super(expression, sourceLocation);
	}

	@Override
	public DoubleType evaluateLegalCase(Program program) {
		return new DoubleType(((GameObjectType) this.getExpression().evaluateLegalCase(program)).getValue().getHeight());
	}
