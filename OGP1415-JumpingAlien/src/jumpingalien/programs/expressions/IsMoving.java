...
*/
public class IsMoving extends CheckerExpression<GameObjectType> {
	 ...
	 */
	public IsMoving(Expression<GameObjectType> expression, Expression<DirectionType> direction, SourceLocation sourceLocation) {
